...
import mmf.com.bubblingdemo.header.astuetz.PagerSlidingTabStrip;

@SuppressLint("NewApi")
public class HeaderMainActivity extends FragmentActivity implements ScrollTabHolder, ViewPager.OnPageChangeListener {
